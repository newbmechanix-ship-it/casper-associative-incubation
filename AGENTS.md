...
7. Search fresh context for mechanism bridges that satisfy blocked requirements.
8. Surface candidate paths with source chains, risk, uncertainty, and required user review.
9. Never take external actions without explicit user approval.
10. Keep runtime data local and out of public commits.
