...
When installing it for a user:

- install locally into `.associative-incubation/`;
- default automatic background LLM calls to off;
- require explicit user assignment for every active problem;
